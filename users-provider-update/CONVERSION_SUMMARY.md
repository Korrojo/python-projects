...
1. ✅ Configure `shared_config/.env` with your credentials (APP_ENV and suffixed keys)
1. ✅ Test with sample CSV first
1. ✅ Run validation after updates

### For Developers

1. ✅ Original Node.js code preserved in `archive/nodejs_original/`
1. ✅ Can reference for business logic if needed
1. ✅ Python version is now the primary implementation
1. ✅ Follow same patterns for future enhancements
