...
def main():
    ...
    try:
        ...
        masked_count = 0
        masked_fields = {"PatientName": 0, "City": 0, "VisitNotes": 0, "VisitAddress": 0, "Comments": 0}
                    ...
                    if "Appointments" in slot and isinstance(slot["Appointments"], list):
                        for appt in slot["Appointments"]:
                            ...
                            if (
                                (
                                    "PatientName" in appt
                                    and isinstance(appt["PatientName"], str)
                                    and appt["PatientName"].isupper()
                                )
                                or ("City" in appt and appt["City"] == "xxxxxxxxxx")
                                or ("VisitNotes" in appt and appt["VisitNotes"] == "xxxxxxxxxx")
                                or ("VisitAddress" in appt and appt["VisitAddress"] == "xxxxxxxxxx")
                                or ("Comments" in appt and appt["Comments"] == "xxxxxxxxxx")
                            ):
                                new_masked_count += 1
                                break
