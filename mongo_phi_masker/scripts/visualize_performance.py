...
def generate_performance_report(metrics_data, output_dir):
    ...
    if "batch_stats" in metrics_data and "batch_size" in metrics_data["batch_stats"].columns:
        ...
        if "batch_size" in batch_stats.columns and "throughput" in batch_stats.columns:
            ...
            """.format(optimal_batch_size=optimal_batch_size)
    ...
    if "batch_stats" in metrics_data and "worker_count" in metrics_data["batch_stats"].columns:
        ...
        if "worker_count" in batch_stats.columns and "throughput" in batch_stats.columns:
            ...
            """.format(optimal_worker_count=optimal_worker_count)
    ...
    if "batch_stats" in metrics_data and "batch_size" in metrics_data["batch_stats"].columns:
        ...
        if "batch_size" in batch_stats.columns and "throughput" in batch_stats.columns:
            ...
            report_html += """
            <li><strong>Batch Size:</strong> Use a batch size of {batch_size} documents for optimal throughput.</li>
            """.format(batch_size=optimal_batch_size)
    ...
    if "batch_stats" in metrics_data and "worker_count" in metrics_data["batch_stats"].columns:
        ...
        if "worker_count" in batch_stats.columns and "throughput" in batch_stats.columns:
            ...
            report_html += """
            <li><strong>Worker Count:</strong> Use {worker_count} workers for optimal throughput.</li>
            """.format(worker_count=optimal_worker_count)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--output-dir", default="reports/performance", help="Directory to save visualizations and report")
