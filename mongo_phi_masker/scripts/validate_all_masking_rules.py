...
class RuleValidator:
    ...
    def __init__(self):
        ...
        self.results = {"timestamp": datetime.now().isoformat(), "overall_results": {}, "rule_results": {}}
            ...
            "replace_string": [
                {
                    ...
                    "value": "123 Main St",
                    "expected_type": str,
                    "format_check": lambda x: x == "xxxxxxxxxx",
                },
                {
                    "field": "Notes",
            ...
            "replace_email": [
                {
                    ...
                    "expected_type": str,
                    "format_check": lambda x: "@" in x and "." in x,
                },
                {
                    "field": "UserEmail",
                    "value": "doctor.smith@hospital.org",
                    "expected_type": str,
                    "format_check": lambda x: "@" in x and "." in x,
                },
            ],
            "replace_gender": [
                {
                    ...
                    "value": "Male",
                    "expected_type": str,
                    "format_check": lambda x: x in ["Male", "Female"],
                },
                {
                    "field": "Gender",
                    "value": "Female",
            ...
            "random_uppercase": [
                {
                    ...
                    "value": "John",
                    "expected_type": str,
                    "format_check": lambda x: x.isupper() and len(x) == len("John"),
                },
                {
                    "field": "LastName",
                    "value": "Smith",
                    "expected_type": str,
                    "format_check": lambda x: x.isupper() and len(x) == len("Smith"),
                },
                {
                    "field": "PatientName",
                    "value": "John Smith",
            ...
            "lowercase_match": [
                {
                    ...
                    "value": "DrJones",
                    "expected_type": str,
                    "format_check": lambda x: x.islower() and len(x) == len("DrJones"),
                },
            ],
            ...
            "add_milliseconds": [
                {
                    ...
                    "value": "1980-01-01",
                    "expected_type": str,
                    "milliseconds": 62208000000,
                    "format_check": lambda x: "-" in x and len(x) == len("1980-01-01"),
                },
                {
                    "field": "Dob",
                    "value": "1930-01-14T00:00:00.000Z",
                    "expected_type": str,
                    "milliseconds": 62208000000,
    ...
    def _validate_rule(self, rule_type, test_cases):
        ...
        results = {"total": len(test_cases), "passed": 0, "cases": []}
        ...
        for case in test_cases:
            ...
            if passed:
                ...
                if not value_changed:
                    ...
                    logger.warning(
                        f"✗ {field} type not preserved: {expected_type.__name__} -> {type(masked_value).__name__}"
                    )
    ...
    def test_rule_groups(self, config_path="config/config_rules/test_config.json"):
        ...
        for group_num, group_data in test_data.items():
            ...
            group_results[group_num] = {"collection": collection_name, "rule_file": rule_file, "field_results": []}
                    ...
                    if field == "PhoneNumber" or field.endswith("PhoneNumber"):
                        if masked_value and masked_value != original_value:
                            if masked_value == "xxxxxxxxxx":
                                logger.warning(
                                    f"Field {field} is using replace_string instead of random_10_digit_number!"
                                )
        ...
        logger.info(
            f"Overall rule group accuracy: {overall_accuracy:.2f}% ({total_fields_masked}/{total_fields_tested})"
        )
    ...
    def print_summary(self):
            ...
            for case in results["cases"]:
                ...
                if not case["passed"]:
                    ...
                    if not case["type_preserved"]:
                        print("      Error: Type not preserved")
        ...
        for group_num, results in group_results["group_results"].items():
            print(
                f"  Group {group_num} ({results['collection']}): {results['accuracy']:.2f}% ({results['fields_masked']}/{results['fields_tested']})"
            )
