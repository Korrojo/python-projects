...
> **📌 Note:** This is the **detailed documentation index**. For quick task-based navigation, see the
> [Master README](../README.md) at repository root.

This directory contains all technical documentation for the Python Projects repository, organized by purpose and
audience.
...
1. **Browse by Type (Comprehensive)** → Use this page
...
1. [guides/NEW_PROJECT_GUIDE.md](guides/NEW_PROJECT_GUIDE.md) - Full walkthrough (30-60 minutes)
1. [guides/COMMON_CONFIG_API_REFERENCE.md](guides/COMMON_CONFIG_API_REFERENCE.md) - ⭐ **Bookmark this** for development
...
1. **Reference material** → Place in `best-practices/`

   - Design patterns
   - Best practices
   - Code examples

1. **Historical records** → Place in `archive/`

   - Completed project summaries
   - Deprecated guides
   - Historical snapshots

1. **Update this README** to include your new document in the appropriate section
